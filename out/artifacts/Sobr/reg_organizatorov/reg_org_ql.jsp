...
<div class="container">
    <div class="ogl">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Oрганизатора собрания (Юридическое лицо)</li>
            </ol>
        </nav>
    </div>
    ...
    <p class="reg_uch" id="ogl">Регистрация организатора ЮЛ</p>
    ...
    <form class="table1">
        ...
        <div class="unn">
            ...
            <input type="text" class="forms" id="inn" placeholder="000000000000000">
        </div>
        <div class="codorg">
            <label for="ogrn" class="txt_obsh">Код ОГРН*</label>
            <input type="text" class="forms3" id="ogrn" placeholder="000000000000000">
        </div>
        <div class="poln_naim">
            <label for="poln_naim" class="txt_obsh">Полное наименование*</label>
            <input type="text" class="forms2" id="poln_naim" placeholder="Полное наименование">
        </div>
        <div class="qr_adres">
            <label for="ur_addr" class="txt_obsh">Юридический адрес*</label>
            <input type="text" class="forms2" id="ur_addr" placeholder="Юридический адрес">
        </div>
        ...
        <div>
            ...
            <button type="button" class="knopka" onclick="Validate_reg ()"> Сохранить и подтвердить e-mail</button></div>

        <label for="file" class="prikrepit-dokument pointer">
            Добавить документ
        ...
        <p class="txt">Перечень документов, которые необходимо приложить
            к заявке, указан в Регламенте работы сервиса</p>

        <p class="txt2">Максимальный объём загружаемого файла 15 Мб. Документ должен быть в формате pdf или jpg</p>
