    ...
    <div class="ogl">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Oрганизатора собрания (Арбитражный управляющий)</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="viewport">
        <div class="login_container">
            <div class="login_block">
                <p class="reg_uch" id="ogl">Регистрация организатора АУ </p>
                ...
                <div class="reg_uch_txt">Для регистрации на электронной площадке Вам следует заполнить приведённую ниже форму. По результатам рассмотрения заявления Вам будет направлено уведомление на указанный в форме адрес электронной почты.
                    ...
                    Внимание! Перед регистрацией Вам следует убедиться, что у вас настроены средства ЭП в соответствии с руководством. Вы регистрируетесь как участник собрания (Арбитражный управляющий). </div>
                ...
                <form class="table2">
                    ...
                    <div class="codorg2">
                        <label for="reg_nomer_au" class="txt_obsh">Регистрационный номер АУ*</label>
                        <input type="text" class="forms4" id="reg_nomer_au" placeholder="000 000">
                    </div>
                    ...
                    <div class="otch">
                        ...
                        <input type="text" class="forms4" id="otch" placeholder="Отчество">
                    </div>
                    ...
                    <div class="nazv_org">
                        <label for="naim_org" class="txt_obsh">Название саморегулируемой организации*</label>
                        <input type="text" class="forms3" id="naim_org" placeholder="Название саморегулируемой организации">
                    </div>
