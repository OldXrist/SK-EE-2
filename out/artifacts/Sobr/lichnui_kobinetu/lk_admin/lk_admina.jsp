...
<div class="container">
    ...
    <form class="table_min">
        ...
        <p class="licd"><b>Личные данные</b></p>
        <p  class="shabl">Шаблоны документов</p>
        <p class="sistem_obsh">Системные настройки</p>

    </form>

    <form class="table_osn">
        ...
        <div class="email">
            ...
            <input type="email" class="forms4" id="nam" placeholder="ivanova12@mail.ru">
        </div>
        <div class="email2">
        ...
        <div class="new_pas">
            ...
            <input type="password" class="forms4" id="nam" placeholder="********">
        </div>
        <div class="new_pas2">
