...
<div class="container">
    ...
    <form class="table_lk">
        ...
        <nav style="--bs-breadcrumb-divider: '';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="lk2_org_fl"><p class="org_sobr">Организация собраний</p></a></li>
                <li class="breadcrumb-item"><a href="lk3_org_fl"><p class="chern_zaiav">Черновики заявок</p></a></li>
            </ol>
        </nav>
    ...
    <form class="table2">
        ...
        <div class="unn">
            ...
            <input type="text" class="forms" id="unn" placeholder="11111111">
        </div>
        <div class="snils">
            <label for="snils" class="txt_obsh">СНИЛС*</label>
            <input type="text" class="forms3" id="snils" placeholder="123 456 789 00">
        </div>
        <div class="telefon">
