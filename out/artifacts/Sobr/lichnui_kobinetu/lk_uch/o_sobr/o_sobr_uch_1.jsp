...
<div class="container">
  <div class="content">
    ...
    <p class="heading">Заявка на участие в очном собрании</p>
    ...
    <div class="ep">
      ...
      <ul class="inline_4 second_4 fader">
        <li>Имя*</li>
        <li><input type="text" placeholder="Зинаида" /></li>
      </ul>
      ...
      <ul class="fader">
        <li>Кем выдан*</li>
        <li><input type="text" placeholder="Кем выдан" class="oneline"/></li>
      </ul>
      <ul class="inline_4 fader">
        <li>Телефон*</li>
      ...
      <ul class="btns fader">
        <li><a class="txtr" href="o_sobr_uch_2.html"><button class="sign">Подписать заявку электронной подписью</button></a></li>
