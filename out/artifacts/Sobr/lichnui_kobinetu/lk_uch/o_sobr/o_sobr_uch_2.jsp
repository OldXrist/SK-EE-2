    ...
    <div class="content">
        ...
        <div class="stats">
            <ul>
                ...
                <li class="stats_item"><a href="o_sobr_uch_3">Бюллетени</a></li>
            </ul>
        </div>
        ...
        <div class="ep">
            ...
            <ul>
                <li><a href="o_sobr_uch_8.html"><button class="sub_btn">Подать заявку на участие в собрании</button></a></li>
            </ul>
        </div>
