    ...
    <form class="table_lk">
        ...
        <nav style="--bs-breadcrumb-divider: '';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="lk2_uch"><p class="org_sobr">Участие в собраниях</p></a></li>
                <li class="breadcrumb-item"><a href="lk3_uch"><p class="chern_zaiav">Черновики заявок</p></a></li>
            </ol>
        </nav>
