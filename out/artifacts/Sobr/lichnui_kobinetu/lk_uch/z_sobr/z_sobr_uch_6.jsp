...
<div class="container">
    <div class="content">
        ...
        <div class="stats">
            <ul>
                <li class="stats_item"><a href="z_sobr_uch_2">Общая информация</a></li>
                <li class="stats_item"><a href="z_sobr_uch_3">Повестка дня</a></li>
                <li class="stats_item"><a href="z_sobr_uch_4">Документы</a></li>
                <li class="stats_item"><a href="z_sobr_uch_5">Заявки</a></li>
                <li class="stats_item"><a href="z_sobr_uch_7">Бюллетени</a></li>
            </ul>
        </div>
