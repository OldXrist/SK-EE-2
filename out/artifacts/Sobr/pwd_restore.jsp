...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="style/pwd_restore.css">
  ...
  <div class="content">
    ...
    <div class="pwd_block">
      <ul>
        ...
        <li><input type="text" placeholder="Email" class="form_f"/></li>
        <li><input type="submit" value="Восстановить пароль" class="sgn_btn"/></li>
      </ul>
    </div>
