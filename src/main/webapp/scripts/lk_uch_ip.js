$.get("http://localhost:8080/Sobr/LKIPServlet", function (data) {
    console.log(data)
    ...
    document.getElementById("pocht_adres").placeholder = d[8]
    document.getElementById("ogrnip").placeholder = d[3]
    document.getElementById("unn").placeholder = d[0]
    document.getElementById("snils").placeholder = d[7]
    document.getElementById("telefon").placeholder = d[1]
    document.getElementById("email").placeholder = d[2]
    document.getElementById("seria").placeholder = d[9]
    document.getElementById("nomer").placeholder = d[10]
    document.getElementById("data").placeholder = d[12]
