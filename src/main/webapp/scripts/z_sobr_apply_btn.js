$.get("/ApplicationBtnServlet", send, function (data){
    ...
    if (data.includes('организатор')){
        if (data.includes('y')){
            window.location.href = '/lichnui_kobinetu/lk_org/z_sobr/z_sobr_org_2.html' + '?sk='+snum[1]
        ...
        } else document.getElementById("apply").href = '/lichnui_kobinetu/lk_uch/z_sobr/z_sobr_uch_1.html' + '?sk='+snum[1]
