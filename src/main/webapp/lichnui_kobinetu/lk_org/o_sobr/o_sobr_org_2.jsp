...
<div class="container">
    <div class="content">
        ...
        <div class="ep">
            ...
            <ul>
                <li>Наименование</li>
                <li><input type="text" placeholder="Зинаида Иван Иванович" class="oneline"/></li>
            </ul>
            ...
            <ul>
                <li><a class="txtr" href="#"><button class="knopka6">Отменить собрание</button></a></li>
                <li><a class="txtr" href="#"><button class="knopka7">Редактировать собрание</button></a></li>
                <li><a class="txtr" href="o_sobr_org_8.html"><button class="knopka8">Начать собрание</button></a></li>
            </ul>
        </div>
