...
<div class="container">
    ...
    <form class="table_lk">
        ...
        <nav style="--bs-breadcrumb-divider: '';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="lk2_org_ip2"><p class="org_sobr">Организация собраний</p></a></li>
                <li class="breadcrumb-item"><a href="lk3_org_ip2"><p class="chern_zaiav">Черновики заявок</p></a></li>
            </ol>
        </nav>

        <img class="logout-1-traced"
             src="https://static.overlay-tech.com/assets/3373d3e0-dfbb-4718-9044-d75c865a7c23.svg"/>
        <p class="login">Зинаида И.</p>
    ...
    <form class="table2">
        ...
        <div class="name">
            ...
            <input type="text" class="forms4" id="nam" placeholder="Зинаида">
        </div>
        <div class="otch">
