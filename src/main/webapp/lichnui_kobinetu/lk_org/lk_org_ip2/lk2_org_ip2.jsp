...
<div class="container">
    ...
    <form class="table_lk">
        ...
        <nav style="--bs-breadcrumb-divider: '';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="lk_org_ip2"><p class="lk_mal">Личные данные</p></a></li>
                <li class="breadcrumb-item active" aria-current="page"><p class="org_sobr_big">Организация собраний</p></li>
    ...
    <form class="table_min">
        <p class="org_sobr2">Организация собраний</p>
        <p class="dob_sobr">Добавить собрание</p>
        <img class="plus" src="../../../img/close%201%20(Traced).svg">
        <ul class="add_drop">
            <li class="form21">Не выбрано</li>
            <li  class="form22"><a class="txtr" href="../../../lichnui_kobinetu/lk_org/o_sobr/o_sobr_org_1.html">Очное</a></li>
            <li class="form23"><a class="txtr" href="../../../lichnui_kobinetu/lk_org/z_sobr/z_sobr_org_1.html">Заочное</a></li>
        </ul>
    </form>
