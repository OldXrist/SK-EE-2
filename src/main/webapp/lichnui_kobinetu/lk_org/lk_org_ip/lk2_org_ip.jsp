...
<div class="container">
    ...
    <form class="table_lk">
        ...
        <nav style="--bs-breadcrumb-divider: '';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="lk_org_ip"><p class="lk_mal">Личные данные</p></a></li>
                <li class="breadcrumb-item active" aria-current="page"><p class="org_sobr_big">Организация собраний</p></a></li>
