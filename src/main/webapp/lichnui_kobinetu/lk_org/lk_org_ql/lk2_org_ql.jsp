...
<div class="container">
  ...
  <form class="table_lk">
    ...
    <nav style="--bs-breadcrumb-divider: '';" aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="lk_org_ql"><p class="lk_mal">Личные данные</p></a></li>
        <li class="breadcrumb-item active" aria-current="page"><p class="org_sobr_big">Организация собраний</p></li>
        <li class="breadcrumb-item"><a href="lk3_org_ql"><p class="chern_zaiav">Черновики заявок</p></a></li>
      </ol>
    </nav>
