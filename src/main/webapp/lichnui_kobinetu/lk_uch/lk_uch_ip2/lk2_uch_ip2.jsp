...
<div class="container">
  ...
  <form class="table_lk">
    ...
    <nav style="--bs-breadcrumb-divider: '';" aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="lk_uch_ip2"><p class="lk_mal">Личные данные</p></a></li>
        <li class="breadcrumb-item active" aria-current="page"><p class="org_sobr_big">Участие в собраниях</p></a></li>
  ...
  <div class="table">
    <div class="table_item_uch">
      ...
      <div class="date">
        ...
        <ul>
          <button type="button" class="knopka_uch_join"><a class="txtr" href="../../../lichnui_kobinetu/lk_uch/o_sobr/o_sobr_uch_1.html">Присоединиться</a></button>
        </ul>
      </div>

    </div>
    <div class="table_item_uch">
      <h3 class="table_h">1013 Зачное</h3>
      <ul class="table_data">
        <li class="thin_text">Организатор</li>
        <li>ООО «Право-Торг»</li>
      </ul>
      ...
      <div class="date">
        ...
        <ul>
          <button type="button" class="knopka_uch_join"><a class="txtr" href="../z_sobr/z_sobr_uch_2.html">Присоединиться</a></button>
        </ul>
      </div>
    </div>
    <div class="table_item_uch">
