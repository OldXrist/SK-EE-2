...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../../style/o_sobr_uch_8.css">
...
<div class="container">
    <div class="content">
        ...
        <div class="q_open">
            <ul class="left">
                <li>00:30&nbsp;</li>
                <li class="status">Идет голосование</li>
            </ul>
            <ul class="right">
                <li>Проголосовало: <b>24/26</b></li>
            </ul>
            <div class="hl"></div>
            ...
            <div class="vote_open">
                ...
                <button class="vote_sign">Голосовать и подписать ЭЦП</button>
            </div>
            <button class="vote_active">Голосовать</button>
        </div>
        ...
        <div class="q_closed">
            ...
            <p class="vote_inactive">Голосование завершено</p>
        </div>
        ...
        <div class="q_soon">
            ...
            <p class="vote_inactive">Скоро начнется голосование</p>
        </div>
