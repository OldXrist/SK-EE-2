...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../style/uchfl.css">
  ...
  <div class="ogl">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Участник собрания (Индивидуальный предприниматель)</li>
      </ol>
    </nav>
  </div>
  ...
  <div class="viewport">
    <div class="login_container">
      <div class="login_block">
        <p class="reg_uch" id="ogl">Регистрация участника ФЛ </p>
        ...
        <form class="table2">
          ...
          <div class="email2">
            ...
            <input type="text" class="forms" id="email" placeholder="Электронная почта">
          </div>
          ...
          <p class="prikrepit-dokument2 pointer">Добавить документ</p>
...
<script src="../scripts/reg_docs_ip.js"></script>
