...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../style/uchip.css">
    ...
    <div class="viewport">
        <div class="login_container">
            <div class="login_block">
                <p class="reg_uch" id="ogl">Регистрация участника ИП </p>
                ...
                <form class="table2">
                    ...
                    <div class="codorg2">
                        <label for="ogrnip" class="txt_obsh">Код ОГРНИП*</label>
                    ...
                    <div class="data_vidochi">
                        ...
                        <input type="text" class="forms5" id="vidacha" placeholder="01.01.0000">
                    </div>
